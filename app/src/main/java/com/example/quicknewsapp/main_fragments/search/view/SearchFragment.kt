package com.example.quicknewsapp.main_fragments.search.view
...
import com.example.quicknewsapp.main_fragments.feed.SearchFeedFragment
import com.example.quicknewsapp.main_fragments.search.SearchDatabase
import com.example.quicknewsapp.main_fragments.search.SearchItem
import com.example.quicknewsapp.main_fragments.search.view.SearchHistoryAdapter.OnRecentSearchClickedListener
...
class SearchFragment : AppMainFragment(), OnRecentSearchClickedListener {
    ...
    private fun getSearchDatabase() : SearchDatabase {
        return Room.databaseBuilder(activity!!.applicationContext,
                SearchDatabase::class.java, Constants.SEARCH_DB).build()
    }
}