package com.davidwskang.quicknewsapp.feed
...
import com.davidwskang.quicknewsapp.bookmarks.BookmarkedArticlesViewModel
import com.davidwskang.quicknewsapp.R
import com.davidwskang.quicknewsapp.AppFragment
import com.davidwskang.quicknewsapp.feed.FeedAdapter.OnFeedItemClickedListener
import com.davidwskang.quicknewsapp.model.Article
import com.davidwskang.quicknewsapp.model.Feed
import com.davidwskang.quicknewsapp.confirm.ConfirmBookmarkFragment
import com.davidwskang.quicknewsapp.confirm.ConfirmOpenArticleFragment
...
abstract class FeedFragment : AppFragment(), OnFeedItemClickedListener {
    ...
    override fun onFeedItemClicked(article: Article) {
        mainActivity!!.supportFragmentManager
                .beginTransaction()
                .add(R.id.full_screen_fragment_container, ConfirmOpenArticleFragment.newInstance(article))
                .commit()
    }

    override fun onFeedItemLongPress(article: Article) {
        mainActivity!!.showConfirmModal(ConfirmBookmarkFragment.newInstance(article))
    }
