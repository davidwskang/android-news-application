...
import com.davidwskang.quicknewsapp.AppMainFragment
import com.davidwskang.quicknewsapp.feed.FeedAdapter
...
class BookmarksFragment : AppMainFragment(), FeedAdapter.OnFeedItemClickedListener {
    ...
    override fun onFeedItemClicked(article: Article) {
        mainActivity!!.showConfirmModal(ConfirmOpenArticleFragment.newInstance(article))
    }
